...
public class Images {
	...
	public static final ImageIcon Over = createImageIcon("images/Over.gif");
	
	public static final ImageIcon Run = createImageIcon("images/Run.gif");
	
	public static final ImageIcon GAMEWIN = createImageIcon("images/GameWin.png");
	
	public static final ImageIcon GAMELOSE =createImageIcon("images/GameLose.jpg") ;
